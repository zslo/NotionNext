...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS ||'意识于黑夜里逃逸 阴影于洞穴内排泄',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '香蕉鱼', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO ||'',// 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://zslo.club', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客', // 网站关键词 英文逗号隔开

  <iframe frameborder="no" border="0" marginwidth="0" marginheight="0" width=330 height=86 src="//music.163.com/outchain/player?type=2&id=18001009&auto=1&height=66"></iframe>
  ...
  CONTACT_BILIBILI: process.env.NEXT_PUBLIC_CONTACT_BILIBILI || 'https://www.douban.com/people/177590091/?_i=18126313IcH42U', // B站主页
  ...
  POSTS_SHARE_SERVICES: process.env.NEXT_PUBLIC_POST_SHARE_SERVICES || 'link,wechat,email,twitter,telegram', // 分享的服務，按顺序显示,逗号隔开
  ...
  DESCRIPTION:
        process.env.NEXT_PUBLIC_DESCRIPTION || '黑夜里的哀嚎', // 站点描述，被notion中的页面描述覆盖
